  ...
  return (
    ...
    >
      <motion.div
        ...
        className="glass-panel modal-panel-lg neon-border"
        ...
        <div className="modal-content-split">
            ...
            <div className="visual-footer">
              <div className="visual-stars">
                {[...Array(char.rarity)].map((_, i) => (
                  <Star key={i} size={16} className="text-gold" />
                ))}
              </div>
          ...
          <div className="modal-details-side">
            ...
            <div className="details-bio glass-panel">
              <p>
                "High-performance operative secured from the {char.game?.toUpperCase()} mainframe.
                Integrated with advanced neural protocols for peak combat efficiency."
              </p>
            </div>
        ...
        <div className="chars-header">
          <div className="header-info">
            ...
            <h1 className="header-title">
              OPERATIVE <span className="text-gradient">DATABASE</span>
            </h1>
          </div>
        ...
        <div className="filter-bar glass-panel">
          ...
          <div className="game-filters">
            {Object.entries(GAMES).map(([k, v]) => (
              <button
                key={k}
                className={`game-btn ${game === k ? 'active' : ''}`}
                onClick={() => {
                  setGame(k);
                  setDisplayCount(30);
                }}
          ...
          <div className="rarity-filters">
            {['all', '5', '4'].map((r) => (
              <button
                key={r}
                className={`rarity-btn ${rarity === r ? 'active' : ''}`}
                onClick={() => {
                  setRarity(r);
                  setDisplayCount(30);
                }}
                      ...
                      <div className="char-card-info">
                        <div className="char-card-top">
                          ...
                          <div className="char-stars">
                            {[...Array(c.rarity)].map((_, i) => (
                              <Star key={i} size={8} className="text-gold" />
                            ))}
                          </div>
                        </div>
