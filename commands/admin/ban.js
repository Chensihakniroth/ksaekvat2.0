...
module.exports = {
  ...
  async execute(message, args, client) {
          ...
          embeds: [
            {
              ...
              description:
                'Mommy cannot ban this user. They might be too powerful for me. (っ˘ω˘ς)',
            },
          ],
        });
      }
          ...
          embeds: [
            {
              ...
              description:
                "I cannot ban this user as they have a role equal to or higher than Mommy's. (◕‸ ◕✿)",
            },
          ],
        });
      }
    ...
    const dmEmbed = new EmbedBuilder()
      ...
      .setDescription(
        `You have been banned from **${message.guild.name}**. Mommy hopes you learn from this. (っ˘ω˘ς)`
      )
      .addFields(
        {
          name: 'Reason',
    ...
    message.guild.members
      ...
      .then(() => {
        const successEmbed = new EmbedBuilder()
          ...
          .setDescription(
            `**${target.tag}** has been sent away. Mommy did it for the server! (｡♥‿♥｡)`
          )
          .addFields(
            {
              name: '(◕‿◕✿) Banned User',
