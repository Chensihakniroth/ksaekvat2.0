...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    switch (itemType) {
      ...
      case 'balance':
        ...
        resultEmbed = new EmbedBuilder()
          ...
          .setDescription(
            `Mommy successfully gave **${amount.toLocaleString()}** ${config.economy.currency} to **${target.username}**! ヽ(>∀<☆)ノ`
          )
          .addFields({
      ...
      case 'xp':
        ...
        resultEmbed = new EmbedBuilder()
          ...
          .setDescription(
            `Mommy successfully gave **${amount}** XP to **${target.username}**! ヽ(>∀<☆)ノ`
          )
          .addFields({
      ...
      case 'moneybooster':
        ...
        resultEmbed = new EmbedBuilder()
          ...
          .setDescription(
            `Mommy successfully gave a **Money Booster x2** to **${target.username}**! ヽ(>∀<☆)ノ`
          )
          .addFields({
      ...
      case 'xp_booster':
        ...
        resultEmbed = new EmbedBuilder()
          ...
          .setDescription(
            `Mommy successfully gave an **Experience Booster x2** to **${target.username}**! ヽ(>∀<☆)ノ`
          )
          .addFields({
            name: '(◕‿◕✿) Booster Details',
            value: [
    ...
    if (success && resultEmbed) {
      ...
      console.log(
        `[ADMIN] ${message.author.tag} gave ${target.tag} ${itemType} ${amount || 'default'}`
      );
