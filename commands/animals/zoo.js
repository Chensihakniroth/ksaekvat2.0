...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    const { totalAnimals, totalValue, rarityStats } = AnimalService.calculateZooStats(
      userAnimals,
      animalsData
    );
    ...
    if (totalAnimals > 0) {
      ...
      const badges = AnimalService.calculateBadges(
        userData.stats?.totalAnimalsFound || 0,
        totalValue,
        userAnimals
      );
