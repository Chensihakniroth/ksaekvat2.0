...
/**
 * 🎨 TEAM RENDERER — Premium 3-Slot Pokémon Team Display
 * Renders a visually stunning card grid showing active Pokémon
 * with official artwork, type colors, and detailed battle stats.
 */
...
export interface TeamPokemonStats {
  hp: number;
  atk: number;
  def: number;
  speed: number;
...
class TeamRenderer {
   ...
   */
  public async renderTeam(
    pokemon: TeamPokemon[],
    statsMap: Map<string, TeamPokemonStats>,
