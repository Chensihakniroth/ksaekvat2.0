...
// ─── STAT CACHE ────────────────────────────────────────────────────────
const baseStatCache: Map<string, { hp: number; atk: number; def: number; spAtk: number; spDef: number; speed: number; types: string[] }> = new Map();
...
class PokemonBattleService {
   ...
   */
  public async getBaseStats(speciesKey: string): Promise<{ hp: number; atk: number; def: number; spAtk: number; spDef: number; speed: number; types: string[] } | null> {
   ...
   */
  public async buildBattlePokemon(userPokemon: any, side: 'A' | 'B'): Promise<BattlePokemon | null> {
