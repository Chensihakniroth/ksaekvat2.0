...
const AnimalRegistry =
  require('../models/AnimalRegistry').default || require('../models/AnimalRegistry');
...
async function checkAndInjectGen2() {
  try {
    ...
    const gen2Data = JSON.parse(
      fs.readFileSync(path.join(__dirname, '../../gen2_pokemon.json'), 'utf8')
    );
