...
module.exports = {
  ...
  async execute(message, args, client) {
      ...
      return message.reply({
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(
              'How much do you want to deposit? (・_・ヾ\nUsage: `kdeposit <amount/all>`'
            ),
        ],
      });
    }
      ...
      return message.reply({
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(
              "You can't deposit that! (・_・ヾ Check your wallet balance first. (≧◡≦)"
            ),
        ],
      });
    }
      ...
      return message.reply({
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(
              `You only have **${user.balance.toLocaleString()}** ${config.economy.currencySymbol} in your wallet! (ಥ﹏ಥ)`
            ),
        ],
      });
    }
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        `Transferred **${amount.toLocaleString()}** ${config.economy.currencySymbol} to your bank storage! (¬‿¬)`
      )
      .addFields(
        {
          name: '💵 Wallet',
