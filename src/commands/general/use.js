...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    let type = '';
    if (itemName.includes('master')) type = 'masterball';
    else if (itemName.includes('ultra')) type = 'ultraball';
    else if (itemName.includes('poke')) type = 'pokeball';
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        `You used a **${ballNames[type]}**, sweetie! (｡♥‿♥｡)\n\n` +
