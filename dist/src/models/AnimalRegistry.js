 ...
 */
const AnimalRegistrySchema = new mongoose_1.Schema({
...
const AnimalRegistry = mongoose_1.default.model('AnimalRegistry', AnimalRegistrySchema);
exports.default = AnimalRegistry;
