...
async function handleDMForwarding(message, client) {
    ...
    if (!adminTarget)
        return;
    try {
        const channel = client.channels.cache.get(adminTarget.channelId) ||
