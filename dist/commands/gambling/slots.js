...
module.exports = {
    ...
    async execute(message, args, client) {
        ...
        async function updateSlotDisplay(stage) {
            ...
            slotEmbed.setDescription(`**Bet:** ${betAmount.toLocaleString()} ${config.economy.currency}\n\n` +
        ...
        for (let stage = 0; stage <= 7; stage++) {
            ...
            await new Promise((resolve) => setTimeout(resolve, stage < 2 ? 200 : stage < 4 ? 250 : stage < 6 ? 300 : 400));
        }
        if (selectedOutcome.type === 'diamond' ||
            selectedOutcome.type === 'rocket' ||
            selectedOutcome.type === 'coin') {
            ...
            slotEmbed
                ...
                .setDescription(`**${selectedOutcome.name}**\n\n` +
            ...
            slotEmbed
                ...
                .setDescription(`🎰 ┃ ${displaySymbols.first} ┃ ${displaySymbols.middle} ┃ ${displaySymbols.last} ┃\n\n` +
