...
module.exports = {
    ...
    async execute(message, args, client) {
        ...
        if (characters.length === 0) {
            return message.reply("💸 Oh no, darling! You don't have any characters yet. Use `Kwish` to start your collection! (｡•́︿•̀｡)");
        }
        // Group by name
        ...
        const createEmbed = () => {
            ...
            const description = pageItems
                ...
                const rarityEmoji = getRarityEmoji(c.rarity, client, c);
        ...
        const createButtons = () => {
            ...
            const row1 = new ActionRowBuilder().addComponents(new ButtonBuilder()
                ...
                .setStyle(currentSort === 'rarity' ? ButtonStyle.Primary : ButtonStyle.Secondary), new ButtonBuilder()
                .setCustomId('sort_game')
                .setLabel('Sort: Game')
                .setStyle(currentSort === 'game' ? ButtonStyle.Primary : ButtonStyle.Secondary), new ButtonBuilder()
