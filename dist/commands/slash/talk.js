    ...
    async execute(interaction) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields({ name: 'Server', value: channel.guild?.name || 'Direct Messages', inline: true }, { name: 'Channel', value: channel.name || 'Unknown', inline: true }, { name: 'Channel ID', value: channelId, inline: false });
