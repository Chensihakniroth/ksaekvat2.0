                ...
                try {
                    ...
                    if (game === 'genshin') {
                        ...
                        if (pageId !== '-1' && pages[pageId].imageinfo) {
                            ...
                            if (isValidImageBuffer(hsrBuf))
                                imageBuffer = hsrBuf;
                            else
                                throw new Error(`HSR Fandom wiki returned non-image data for ${item.name}`);
                        }
                        useCover = false;
                    }
                    else if (game === 'wuwa') {
                        ...
                        if (pageId !== '-1' && pages[pageId].imageinfo) {
                            ...
                            if (isValidImageBuffer(wuwaBuf))
                                imageBuffer = wuwaBuf;
                            else
                                throw new Error(`WuWa Fandom wiki returned non-image data for ${item.name}`);
                        }
                        useCover = false;
                    }
                    else if (game === 'zzz') {
                        ...
                        if (pageId !== '-1' && pages[pageId].imageinfo) {
                            ...
                            if (isValidImageBuffer(zzzBuf))
                                imageBuffer = zzzBuf;
                            else
                                throw new Error(`ZZZ Fandom wiki returned non-image data for ${item.name}`);
                        }
                        useCover = false;
                    }
